...
echo "  Works globally from any app. The ClaudeApproveAll background app must be"
echo "  running (it starts automatically at login via LaunchAgent)."
echo ""
echo "REQUIRED FOR SHORTCUT: Grant Accessibility permission to ClaudeApproveAll:"
echo "  System Settings → Privacy & Security → Accessibility → add ClaudeApproveAll"
echo "  (The app will prompt you automatically on first launch.)"
echo ""
